    ...
    <div class="loginWrap">
        ...
        <ul class="memberType clear">
            <li style="width:130px;">
         		<input type="text" name="UserId"  placeholder="Insert ID" style="
         		height:22px;">
			<br>
				<input type="text" name="UserPw"  placeholder="Insert PW" style="
         		height:22px;">
            </li>
            <li style="width:90px;">
            	<input type="button"class="btn btn1" value="로그인">
            </li>
        </ul>
        <div class="mbrLinks clear">
            <span class="mbr dotum">
                <a href="http://127.0.0.1:8080/testwebb/joingen.tiles" class="devHref devClick" data-click-value="55"><strong>회원가입</strong></a><span class="idBx"><a href="http://127.0.0.1:8080/testwebb//Login/Search/Search_Id.asp" class="devHref devClick" data-click-value="56">ID</a></span><span class="pwBx"><a href="http://127.0.0.1:8080/testwebb//Login/Search/Search_Pwd.asp" class="devHref devClick" data-click-value="56">PW 찾기</a></span>
            </span>
