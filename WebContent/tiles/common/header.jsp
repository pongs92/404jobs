...
<script type="text/javascript" src="/sripts/EchoScriptV2.js"></script>
...
<div class="search">
    ...
    <form name="global_seek" id="AKCFrm" autocomplete="off" action="/Search/" onsubmit="return GoMainTotalSearch();" target="_self">
        <fieldset>
            ...
            <div class="smKey">
                <input type="text" id="stext" title="검색어 입력" name="stext" maxlength="50" style="background: none;">
                <!-- // 기존 자동완성 들어갈 영역 -->
                <div id="AKCDiv" class="autoSearch" style="display: block; position: absolute;">
                    <!-- // 기능 끈 상황 -->
    ...
    <div class="lyNavInner side">
        <div class="lyRow row01">
            <div class="lyCol col4">
                <div class="colItem">
                    <strong class="titArea"><a href="http://www.jobkorea.co.kr/recruit/home" class="tit">채용정보<span class="spGnb"></span></a></strong>
                    <div class="listBx">
                        <ul>
                            <li><a href="http://www.jobkorea.co.kr/recruit/joblist?menucode=search">상세검색</a></li>
                            <li><a href="http://www.jobkorea.co.kr/recruit/joblist?menucode=local&amp;localorder=1">지역별</a></li>
                            <li><a href="http://www.jobkorea.co.kr/recruit/joblist?menucode=duty">직무별</a></li>
                            <li><a href="http://www.jobkorea.co.kr/recruit/joblist?menucode=industry">산업별</a></li>
                            <li><a href="http://www.jobkorea.co.kr/recruit/joblist?menucode=cotype1&amp;cotype=1,2,3">기업별</a></li>
            ...
            <div class="lyCol col4">
                <div class="colItem">
                    <strong class="titArea"><a href="http://www.jobkorea.co.kr/starter" class="tit">신입공채<span class="spGnb"></span></a></strong>

                    <div class="listBx">
                        <ul>
                            <li><a href="http://www.jobkorea.co.kr/starter/">1000대기업 공채</a></li>
                            <li><a href="http://www.jobkorea.co.kr/starter/calendar/">공채달력</a></li>
                            <li><a href="http://www.jobkorea.co.kr/starter/company/">기업공채전략</a></li>
                            <li><a href="http://www.jobkorea.co.kr/starter/interview">직무인터뷰</a></li>
                            <li><a href="http://www.jobkorea.co.kr/starter/jobfair/">채용설명회</a></li>
                            <li><a href="http://www.jobkorea.co.kr/starter/spec/">합격스펙</a></li>
                            <li><a href="http://www.jobkorea.co.kr/starter/passassay/">합격자소서</a></li>
                            <li><a href="http://www.jobkorea.co.kr/starter/review/">인적성·면접후기</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="lyCol col4">
                <div class="colItem">
                    <strong class="titArea"><a href="http://www.jobkorea.co.kr/headhunting/home" class="tit">헤드헌팅<span class="spGnb"></span></a></strong>

                    <div class="listBx">
                        <ul>
                            <li><a href="http://www.jobkorea.co.kr/headhunting/home">헤드헌팅 채용정보</a></li>
                            <li><a href="http://www.jobkorea.co.kr/headhunting/headhunter/">헤드헌터 찾기</a></li>
                            <li><a href="http://www.jobkorea.co.kr/User/consulting">헤드헌팅 채용상담</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="lyCol col4">
                <div class="colItem">
                    <strong class="titArea"><a href="http://www.jobkorea.co.kr/hr/" class="tit">파견·대행<span class="spGnb"></span></a></strong>

                    <div class="listBx">
                        <ul>
                            <li><a href="http://www.jobkorea.co.kr/hr/?schstat=#JobForm">상세검색</a></li>
                            <li><a href="http://www.jobkorea.co.kr/List_HR/HR_Area.asp">지역별</a></li>
...
<!-- 채용정보 레이어 // -->
                        ...
                        <!-- 메뉴 활성화 클래스 navFixed 마우스 오버시 active 클래스 추가 -->
                        <li id="gnbGg" class="navItem gg lyNull">
                            <a href="http://www.jobkorea.co.kr/Corp/Person/Find" class="linkItem"><span class="spNav"><span class="txIr">인재검색</span></span></a>
                        </li>
...
<script src="/sciprts/jquery?v=FVs3ACwOLIVInrAl5sdzR2jrCDmVOWFbZMY6g6Q0ulE1"></script>

<script src="/sciprts/backbone?v=v0-3Qm9SB2AUlk_aeK9GniBVmVTE9yxsGpDYtXZWlYU1"></script>
