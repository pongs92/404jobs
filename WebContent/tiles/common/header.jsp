...
<div id="header" class="">
	...
	<div class="headInner">
		<h1 class="jkLogo">
			<a href="https://www.jobkorea.co.kr">취업 준비의 시작! 잡코리아</a>
		</h1>
		<!-- // search -->
		<div class="search">
			<h2 class="skip">검색</h2>
						...
						<div id="AKCDiv" class="autoSearch">
							...
							<div id="SearchStop" class="autoSearchStop">
								<p class="btnArrow" id="btnArrow_C">
									<button type="button" title="열림" class="devAcDisabledInfoOpen">
								...
								<p class="btnArrow btnArrowClose" id="btnArrow_O">
									<button type="button" title="닫힘" class="devAcDisabledInfoClose">
		...
		<div class="navInner">
						...
						<div class="lyNavInner side">
							<div class="lyRow row01">
								...
								<div class="lyCol col4">
									<div class="colItem">
										<strong class="titArea"><a
											href="http://www.jobkorea.co.kr/headhunting/home" class="tit">헤드헌팅<span
												class="spGnb"></span></a></strong>
											...
											<ul>
												...
												<li><a
													href="http://www.jobkorea.co.kr/headhunting/headhunter/">헤드헌터
														찾기</a></li>
												<li><a href="http://www.jobkorea.co.kr/User/consulting">헤드헌팅
														채용상담</a></li>
											</ul>
										</div>
									</div>
			...
			<div class="jkNavArea">
				...
				<ul class="serviceNav">
					...
					<!-- 메뉴 활성화 클래스 navFixed 마우스 오버시 active 클래스 추가 -->
					<li id="gnbGg" class="navItem gg lyNull"><a
						href="http://www.jobkorea.co.kr/Corp/Person/Find" class="linkItem"><span
							class="spNav"><span class="txIr">인재검색</span></span></a></li>
					...
					<li class="corp">
						...
						<div class="lyMyArea">
							...
							<div class="myInner">
								...
								<div class="myLists">
									<ul>
										...
										<li><a href="http://www.jobkorea.co.kr/Corp/Person/Find"><span
							...
							<button class="btnMyClose" type="button">
								<span class="spGnb"></span><span class="skip">기업회원 메뉴 닫기</span>
							</button>
							<span class="icnArr spGnb"></span>
						</div>
